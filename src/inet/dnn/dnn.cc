...
/*updates begin*/
std::vector<bool>* dnn::calculateDnn(double attention,double dist, double delay){
    ...
    this->connections->operator [](2)->values->push_back(attention);
    this->connections->operator [](2)->recWeights->push_back(1);
    this->connections->operator [](2)->functionValue=attention;
...
//    this->connections->operator [](1)->recWeights->push_back(1);
//    this->connections->operator [](1)->functionValue=delay;
    this->connections->operator [](1)->values->push_back(attention);
    this->connections->operator [](1)->recWeights->push_back(1);
    this->connections->operator [](1)->functionValue=attention;
